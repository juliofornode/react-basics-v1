...
//onClick: if we want to pass parameters to the function, we need to use an arrow function
//onClick={() => this.playAudio(track.preview_url)}

//if we do this instead, the function is automatically invoked (without clicking):
//onClick={this.playAudio(track.preview_url)}
