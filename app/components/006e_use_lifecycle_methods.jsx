//in project count-down by David Katz in Udemy:
//used lifecycle methods to calculate time remaining till selected date

//componentWillMount sets the initial time remaining
//in componentDidMount, we use setInterval to decrease time each second
